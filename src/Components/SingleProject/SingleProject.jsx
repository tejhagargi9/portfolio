...
function SingleProject({ name, description, stack, images, links, video }) {
  ...
  return (
    <div className="single-project">
      <div className="image-and-controls">
        <Splide className="images-container">{mappedImages}</Splide>

        <div className="controls">
          <button>
            <img src={controlArrow} alt="move slider back by 1 image" />
          </button>

          <button>
            <img src={controlArrow} alt="move slider forward by 1 image" />
          </button>
        </div>
      </div>
      ...
      <div className="text-stuff">
        ...
        <div className="tags">{mappedStack}</div>

        <div className="project-buttons">
            <a target="_blank" href={links[0]}>
              <button>
                Live Site <img src={link} />
              </button>
            </a>
            <a target="_blank" href={links[1]}>
              <button>
                Source Code <img src={github} />
              </button>
            </a>
        </div>
      </div>
